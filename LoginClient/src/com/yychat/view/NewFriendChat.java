...
//    private JList<String> friendList;
    ...
    public NewFriendChat(String friendName) {
        setTitle(friendName);
        setSize(900, 650);
        //setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(null);
        ImageIcon icon = new ImageIcon("res/0.jpg");
        ImageIcon icon2 = new ImageIcon("res/1.jpg");
        initComponents();
        setVisible(true);
        addMessage(icon,"测试测试测试",true,new Date(System.currentTimeMillis()));
        addMessage(icon,"测试测试测试",false,new Date(System.currentTimeMillis()));
        addMessage(icon,"测试测试测试",false,new Date(System.currentTimeMillis()));
        addMessage(icon,"测试测试测试",false,new Date(System.currentTimeMillis()));
    }
...
//            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new NewFriendChat("Abc"));
    }
}